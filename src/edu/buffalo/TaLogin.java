...
public class TaLogin {
	...
	private void displayResults() {
		...
		mainFrame = new JFrame("TA Portal");
		...
		JLabel studentNameLabelValue = new JLabel("Student Name:");
		...
		JLabel studentEmailLabelValue = new JLabel("Student Email:");
		...
		JLabel studentQuestionLabelValue = new JLabel("Student Queries:");
		...
		JLabel studentScheduledTimeLabelValue = new JLabel("Scheduled Time:");
	 ...
	 * @return
	 */
	private static List<Date> getShuffledTimeList(ArrayList<Date> timeList) {
	...
	private static String getTime(int minutes) {
		...
		String dateFormatted = formatter.format(newTime);
